...
namespace WebProje.Controllers
{
    public class AdresController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,AdresAd,Ulke,Il,Ilce")] Adres adres)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,AdresAd,Ulke,Il,Ilce")] Adres adres)
        {
            if (id != adres.Id)
            {
                return NotFound();
